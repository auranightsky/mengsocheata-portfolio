    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-brand text-primary-foreground shadow-brand hover:-translate-y-0.5 hover:shadow-brand-lg",
        soft: "border border-border bg-card text-foreground shadow-soft hover:-translate-y-0.5 hover:border-primary/30 hover:bg-accent",
      },
      size: {
